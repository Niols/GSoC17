...
public class SymbolicInstructionFactory extends gov.nasa.jpf.jvm.bytecode.InstructionFactory {
	...
	return (filter.isPassing(ci)
		? (seplogic
		   ? new gov.nasa.jpf.symbc.bytecode.seplogic.GETFIELD(fieldName, clsName, fieldDescriptor)
		   : new GETFIELD(fieldName, clsName, fieldDescriptor))
